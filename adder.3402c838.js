...
},{}],"quW7":[function(require,module,exports) {
"use strict";

var _timer__class = require("../timer/timer__class");
...
var AdderTimer = /*#__PURE__*/function () {
  function AdderTimer(element) {
    _classCallCheck(this, AdderTimer);

    this.bindedAddNewTimer = this.addNewTimer.bind(this);
  ...
  _createClass(AdderTimer, [{
    key: "addNewTimer",
    value: function addNewTimer() {
      this.selfElement.parentNode.insertBefore(document.importNode(this.template.content, true), this.selfElement);
      var newTimer = this.selfElement.previousElementSibling;
      if (!newTimer) throw new ReferenceError("\u0432\u0435\u0440\u043E\u044F\u0442\u043D\u043E \u043D\u0435 \u043F\u043E\u043B\u0443\u0447\u0438\u043B\u043E\u0441\u044C \u0441\u043E\u0437\u0434\u0430\u0442\u044C \u043D\u043E\u0432\u044B\u0439 \u0442\u0430\u0439\u043C\u0435\u0440, \u0442.\u043A. \u043E\u043D \u043E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u0435\u0442 \u043F\u0435\u0440\u0435\u0434 tag: ".concat(this.selfElement.tagName, " class: ").concat(this.selfElement.classList.toString)); // (newTimer as any).myTimer = new Timer(newTimer);
    }
  }, {
    key: "destruct",
...
document.querySelectorAll('.adder').forEach(function (q) {
  return q.addTimer = new AdderTimer(q);
});
var vm = new _vue.default({
  ...
  methods: {
    newTimer: _timer__class.Timer
  },
  mounted: function mounted() {
    this.$nextTick(function () {
      this.$data.myTimer = new _timer__class.Timer(this.$el);
      console.log(this.$data.myTimer);
    });
  }
}); // console.log(vm.$data.a);
},{"../timer/timer__class":"cTU8","vue":"JTVE"}]},{},["quW7"], null)
//# sourceMappingURL=adder.3402c838.js.map