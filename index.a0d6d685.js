...
},{}],"cTU8":[function(require,module,exports) {
"use strict";
...
var Timer = /*#__PURE__*/function () {
  function Timer(element) {
    ...
    this.HOU = 60 * this.MIN;
    this.bindedPlayPauseToggle = this.playPauseToggle.bind(this);
    this.bindedStop = this.stop.bind(this);
    var temp = element.querySelector('.timer__button-play_pause');
  ...
  _createClass(Timer, [{
    ...
    value: function play() {
      ...
      setTimeout(function () {
        return _this.selfElement.classList.add('timer-active');
      }.bind(this), 0);
    }
  }, {
    key: "pause",
    value: function pause() {
      ...
      if (!isNaN(this.idInterval)) clearInterval(this.idInterval);
      setTimeout(function () {
        return _this2.selfElement.classList.remove('timer-active');
      }.bind(this), 0);
    }
  }, {
    key: "tick",
    value: function tick() {
      ...
      var lengthTime = Date.now();
      if (!this.isActive) return;
      setTimeout(function () {
        lengthTime += _this3.countedTime.getTime() - _this3.lastStartTime.getTime();
        var temp = Math.trunc(lengthTime % _this3.MIN / _this3.SEC);
        var lengthTimeStr = temp.toString().padStart(2, '0');

        if (lengthTime / _this3.MIN >= 1) {
          lengthTime -= temp;
          temp = Math.trunc(lengthTime % _this3.HOU / _this3.MIN);
          lengthTimeStr = temp.toString().padStart(2, '0') + ':' + lengthTimeStr;

          if (lengthTime / _this3.HOU >= 1) {
            lengthTime -= temp;
            temp = Math.trunc(lengthTime / _this3.HOU);
            lengthTimeStr = temp.toString().padStart(2, '0') + ':' + lengthTimeStr;
          }
        }

        setTimeout(_this3.render.bind(_this3), 0, lengthTimeStr);
      }.bind(this), 0);
    }
  }, {
    key: "render",
    value: function render() {
      var time = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '00';
      if ('value' in this.outputElement) this.outputElement.value = time;else this.outputElement.textContent = time;
    }
  }, {
    key: "playPauseToggle",
    value: function playPauseToggle() {
    ...
    value: function stop() {
      ...
      setTimeout(function () {
        return _this4.selfElement.classList.remove('timer-active');
      }.bind(this), 0);
...
exports.Timer = Timer;
},{}],"fGyj":[function(require,module,exports) {
"use strict";
...
var _timer__class = require("./timer__class");
...
var _default = {
  ...
  mounted: function mounted() {
    this.$nextTick(function () {
      this.timer = new _timer__class.Timer(this.$el);
    });
  },
...
exports.default = _default;
        var $b2c37f = exports.default || module.exports;
      
      if (typeof $b2c37f === 'function') {
        $b2c37f = $b2c37f.options;
      }
    
        /* template */
        Object.assign($b2c37f, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _vm._m(0)}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('label',{staticClass:"timer"},[_c('input',{staticClass:"timer__input",attrs:{"type":"text","readonly":"readonly","value":"00"}}),_c('hr',{staticClass:"timer__line"}),_c('div',{staticClass:"timer__buttons_container"},[_c('button',{staticClass:"timer__button-play_pause timer__button material-icons",attrs:{"type":"button"}}),_c('button',{staticClass:"timer__button-stop timer__button material-icons",attrs:{"type":"reset"}},[_vm._v("stop")])])])}]
...
},{"./timer__class":"cTU8"}],"KdhM":[function(require,module,exports) {
"use strict";

var _timer__class = _interopRequireDefault(require("../timer/timer__class"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
        var $4ba836 = exports.default || module.exports;
      
      if (typeof $4ba836 === 'function') {
        $4ba836 = $4ba836.options;
      }
    
        /* template */
        Object.assign($4ba836, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('button',{staticClass:"adder material-icons"},[_vm._v("add")])}
var staticRenderFns = []
...
},{"../timer/timer__class":"cTU8"}],"DbzT":[function(require,module,exports) {
"use strict";
...
var _timer = _interopRequireDefault(require("../../components/timer/timer.vue"));

var _adder = _interopRequireDefault(require("../../components/adder/adder.vue"));
...
var _default = {
  ...
  methods: {
    ...
    removeTimer: function removeTimer(idToRemove) {}
  }
};
exports.default = _default;
        var $691461 = exports.default || module.exports;
      
      if (typeof $691461 === 'function') {
        $691461 = $691461.options;
      }
    
        /* template */
        Object.assign($691461, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"main"},[_vm._l((_vm.timers),function(id){return _c('Timer',{key:id.id,attrs:{"id":id}})}),_c('Adder',{nativeOn:{"click":function($event){return _vm.addTimer($event)}}})],2)}
var staticRenderFns = []
...
},{"../../components/timer/timer.vue":"fGyj","../../components/adder/adder.vue":"KdhM"}],"Focm":[function(require,module,exports) {
"use strict";
...
},{"vue":"JTVE","./index.vue":"DbzT"}]},{},["Focm"], null)
//# sourceMappingURL=index.a0d6d685.js.map