...
})({"d0dd65ca4e269ad5dd11196ebf883f6d":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "1e51140193372b505a21e52605e06d33";
...
},{}],"6ca29d7314f09311a0bf2d1e1ce21b51":[function(require,module,exports) {
"use strict";

var _timer__class = _interopRequireDefault(require("./timer__class"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const arrayOfDestructible = [function () {
  for (let i = 1; i < this.length; this[i++].destruct()) {}
}];
document.q = arrayOfDestructible;
document.querySelectorAll('.timer').forEach(q => arrayOfDestructible.push(q.myTimer = new _timer__class.default(q)));
},{"./timer__class":"a7680d5a8b4be80374dc7ab4732bd606"}],"a7680d5a8b4be80374dc7ab4732bd606":[function(require,module,exports) {
"use strict";
...
class Timer {
  constructor(element) {
    _defineProperty(this, "SEC", 1000);

    _defineProperty(this, "MIN", 60 * this.SEC);

    _defineProperty(this, "HOU", 60 * this.MIN);

    _defineProperty(this, "bindedPlayPauseToggle", this.playPauseToggle.bind(this));

    _defineProperty(this, "bindedStop", this.stop.bind(this));

    let temp = element.querySelector('.timer__button-play_pause');
    if (!temp) throw new ReferenceError(`not elem ".timer__button-play_pause" in tag: ${element.tagName} class: ${element.classList.toString}`);
    this.buttonPlayPauseToggle = temp;
    temp = element.querySelector('.timer__button-stop');
    if (!temp) throw new ReferenceError(`not elem ".timer__button-stop" in tag: ${element.tagName} class: ${element.classList.toString}`);
    this.buttonStop = temp;
    temp = element.querySelector('.timer__input');
    if (!temp) throw new ReferenceError(`not elem ".timer__input" in tag: ${element.tagName} class: ${element.classList.toString}`);
...
},{}]},{},["d0dd65ca4e269ad5dd11196ebf883f6d","6ca29d7314f09311a0bf2d1e1ce21b51"], null)

//# sourceMappingURL=timer.1e511401.js.map
